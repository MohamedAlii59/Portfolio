...
namespace Portfolio.Controllers
{
    ...
    public class TechnologiesController : ControllerBase
    {
        ...
        [Authorize]
        [HttpPost]
        public async Task<IActionResult> Create([FromForm] CreateTechnologyDto dto, [FromForm] IFormFile? icon)
        {
            var created = await _technologyService.CreateAsync(dto, icon);
